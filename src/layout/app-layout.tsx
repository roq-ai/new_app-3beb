...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'team-member', 'collaborator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Accesses', path: '/accesses', entity: 'access', service: AccessServiceEnum.PROJECT, icon: FiKey },
    { name: 'Documents', path: '/documents', entity: 'document', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    {
      name: 'Invitations',
      path: '/invitations',
      entity: 'invitation',
