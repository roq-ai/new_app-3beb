  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience streamlined organization with New_App, your ultimate solution for efficient and effective document management system."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1562654501-a0ccc0fc3fb1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkb2N1bWVudHxlbnwwfHx8fDE2OTM4NTU3NDl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@golfarisa?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Arisa Chattasa`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience streamlined organization with New_App, your ultimate solution for efficient and effective document management system.`}
            </Text>
            <Box
